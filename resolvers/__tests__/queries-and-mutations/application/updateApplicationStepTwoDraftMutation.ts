...
export const UPDATE_APPLICATION_STEP_TWO_DRAFT_MUTATION = gql`
  ...
  mutation updateApplicationStepTwoDraft(
    $id: ID!
    $charter: [FileInputType!]
    $document501c3: [FileInputType!]
    $validationMaterial: ValidationMaterialInputType
    $organisationalStructure: OrganisationalStructureInputType
